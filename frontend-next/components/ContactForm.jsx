    ...
    <>
      {showError && !formState.isFormValid && (
        <div className="form__error">
          There was a problem with your entries.
        </div>
      )}
      <form onSubmit={handleSubmit} noValidate>
        <div className="form__control">
          ...
          <input
            className={
              "form__input " + (formState.fullname.hasError ? "error" : "")
            }
            type="text"
            name="fullname"
        ...
        <div className="form__control">
          ...
          <input
            className={
              "form__input " + (formState.email.hasError ? "error" : "")
            }
            type="email"
            name="email"
        ...
        <div className="form__control">
          ...
          <textarea
            className={
              "form__input " + (formState.message.hasError ? "error " : "")
            }
            name="message"
            id="message"
            cols="20"
